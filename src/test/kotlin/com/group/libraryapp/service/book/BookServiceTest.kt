...
class BookServiceTest @Autowired constructor(
    ...
    fun loanBookTest() {
        ...
        val savedUser = userRepository.save(User("Seol", null))
        val request = BookLoanRequest("Seol", "이상한 나라의 엘리스")
    ...
    fun returnBookTest() {
        ...
        val savedUser = userRepository.save(User("Seol", null))
        userLoanHistoryRepository.save(UserLoanHistory.fixture(savedUser, "이상한 나라의 엘리스"))
        val request = BookReturnRequest("Seol", "이상한 나라의 엘리스")
    ...
    private fun assertCount(results: List<BookStatResponse>, type: BookType, count: Int) {
        val typeCount = results.first { result -> result.type == type }.count
        assertThat(typeCount).isEqualTo(count)
    }
